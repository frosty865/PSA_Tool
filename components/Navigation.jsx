        ...
        <nav style={{ display: 'flex', gap: 'var(--spacing-lg)', alignItems: 'center' }}>
          ...
          <Link
            ...
            style={{
              ...
              borderRadius: 'var(--border-radius)',
              textDecoration: 'none',
              color: pathname === '/dashboard/learning' ? 'var(--cisa-white)' : 'rgba(255,255,255,0.8)',
              backgroundColor: pathname === '/dashboard/learning' ? 'rgba(255,255,255,0.2)' : 'transparent',
              fontWeight: '600',
              fontSize: 'var(--font-size-sm)',
              transition: 'all 0.3s ease',
              border: '2px solid transparent'
            ...
            onMouseEnter={(e) => {
              if (pathname !== '/dashboard/learning') {
                e.target.style.backgroundColor = 'rgba(255,255,255,0.1)';
                e.target.style.color = 'var(--cisa-white)';
              }
            }}
